...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    /* TIM4 DMA Init */
    /* TIM4_CH4 Init */
    hdma_tim4_ch4.Instance = DMA2_Channel1;
    ...
    if (HAL_DMA_ConfigChannelAttributes(&hdma_tim4_ch4, DMA_CHANNEL_NPRIV) != HAL_OK)
    {
      Error_Handler();
    }
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PB9     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = TX_IN1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(TX_IN1_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM15_MspPostInit 0 */
    ...
    PB14     ------> TIM15_CH1
    */
    GPIO_InitStruct.Pin = BL_CTL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF14_TIM15;
    HAL_GPIO_Init(BL_CTL_GPIO_Port, &GPIO_InitStruct);
