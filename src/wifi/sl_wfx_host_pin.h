...
#define SL_WFX_IRQ_GPIO_SPI        GPIO_PIN_0
/* WIRQ pin: PF12 */
#define SL_WFX_WIRQ_PORT           GPIOD
#define SL_WFX_WIRQ_GPIO           GPIO_PIN_0
/* Reset pin: PF13 */
...
/* LED1 pin: PA3 */
#define SL_WFX_LED0_PORT           GPIOB
#define SL_WFX_LED0_GPIO           GPIO_PIN_10
/* LED2 pin: PC0 */
#define SL_WFX_LED1_PORT           GPIOD
#define SL_WFX_LED1_GPIO           GPIO_PIN_14
...
#define SL_WFX_CS_GPIO_SPI         GPIO_PIN_15
#else
