...
#define WLAN_SSID_DEFAULT       "D922"                         ///< wifi ssid for client mode
#define WLAN_PASSKEY_DEFAULT    "77777701"                         ///< wifi password for client mode
...
#define SOFTAP_SSID_DEFAULT     "Ololo"                        ///< wifi ssid for soft ap mode
